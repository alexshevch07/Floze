  ...
  return (
    <footer id="footer" className="bg-footer-bg text-footer-text pt-16 pb-8">
      <div className="site-container">
        {/* lg: same horizontal band as header — first block flush left, last flush right */}
        <div className="mb-14 flex w-full flex-col gap-10 sm:grid sm:grid-cols-2 sm:gap-x-10 sm:gap-y-10 lg:flex lg:flex-row lg:items-start lg:justify-between lg:gap-x-0 lg:gap-y-0">
          ...
          {/* Social — right edge lines up with header CTA on large screens */}
          <div className="min-w-0 lg:text-right">
            ...
            <ul className="flex flex-col gap-2.5 lg:items-end">
              <li>
                <a
                  href="#"
                  className="text-sm text-footer-text/70 hover:text-white transition-colors duration-200 inline-flex w-full items-center gap-2 lg:justify-end"
                >
