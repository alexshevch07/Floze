    ...
    <footer id="footer" className="bg-footer-bg text-footer-text pt-16 pb-8">
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-14">
          ...
          {/* Navigation */}
          <div>
            <h4 className="font-heading text-sm font-semibold text-white mb-4 uppercase tracking-wider">Navigation</h4>
          ...
          {/* Legal */}
          <div>
            <h4 className="font-heading text-sm font-semibold text-white mb-4 uppercase tracking-wider">Legal</h4>
            <ul className="flex flex-col gap-2.5">
          ...
          {/* Social */}
          <div>
            <h4 className="font-heading text-sm font-semibold text-white mb-4 uppercase tracking-wider">Contacts</h4>
            <ul className="flex flex-col gap-2.5">
